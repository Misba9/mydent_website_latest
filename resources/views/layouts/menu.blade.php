...
<li class="nav-item {{ Request::is('admin/ecom*') ? 'active' : '' }}">
...
<li class="nav-item {{ Request::is('homepage-videos*') ? 'active' : '' }}">
    <a class="nav-link" href="{{ route('homepage-videos.index') }}">
        <i class="fas fa-video pe-2"></i> Manage Videos
    </a>
</li>

<li class="nav-item {{ Request::is('admin/main-banners*') ? 'active' : '' }}">
    <a class="nav-link" href="{{ route('main-banners.index') }}">
        <i class="fas fa-image pe-2"></i> Manage Banners
    </a>
</li>
