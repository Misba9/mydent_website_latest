<div class="modal fade" id="changePaymentStatusModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="changePaymentStatusForm">
                    @csrf
                    <input type="hidden" name="appointment_id" id="changePaymentStatusAppointmentId">
                    <div class="mb-4">
                        <label class="form-label required">{{ __('messages.appointment.payment_status') }}</label>
                        <select name="payment_status" id="changePaymentStatusSelect" class="form-select" required>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="submit" class="btn btn-primary" id="btnSavePaymentStatus">{{ __('messages.common.save') }}</button>
                    </div>
                </form>
            </div>
        </div>
