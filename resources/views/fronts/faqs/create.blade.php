            ...
            <div class="card-body p-6">
                {{ Form::open(['route' => 'faqs.store']) }}
                    <div class="mb-5">
                        ...
                        {{ Form::text('question', null, ['class' => 'form-control', 'required', 'placeholder' => 'Enter Question']) }}
                    </div>
                    <div class="mb-5">
                        {{ Form::label('answer', 'Answer:', ['class' => 'form-label required']) }}
                        {{ Form::textarea('answer', null, ['class' => 'form-control', 'rows' => 4, 'required', 'placeholder' => 'Enter Answer']) }}
                    </div>
