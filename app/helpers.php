 ...
 */
function getSettingsKeyedByKey()
{
    static $setting;
...
function getDashboardURL()
{
    ...
    if (Auth::user() !== null) {
        ...
        if (in_array('manage_ecom', $permissions, true)) {
            return 'admin/staff';
        }
...
{
    return optional(getSettingsKeyedByKey()->get($key))->value;
}
...
function getCurrencyIcon()
{
    ...
    $currencyId = optional(getSettingsKeyedByKey()->get('currency'))->value;
